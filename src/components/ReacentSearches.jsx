                        ...
                        recentHistory.map((item, index) => (
                            ...
                            >
                                <li
                                    ...
                                    className="w-full p-1 pl-5 truncate text-zinc-400 cursor-pointer hover:bg-zinc-700 hover:text-zinc-200"
                                >
                                    {item}
                                </li>
